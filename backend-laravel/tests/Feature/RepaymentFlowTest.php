...
class RepaymentFlowTest extends TestCase
{
    ...
    public function test_requester_can_submit_proof_and_donor_confirmation_finishes_the_request(): void
    {
        ...
        $this->assertStringContainsString('5903PIX', $repaymentPixCode);
        $this->assertStringNotContainsString('NEXORA', $repaymentPixCode);
        $this->assertStringNotContainsString('PESSOA DOADORA', $repaymentPixCode);
